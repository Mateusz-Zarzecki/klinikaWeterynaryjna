...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER add_leczenia
BEFORE INSERT ON leczenia
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM leczenia WHERE IdZwierzecia = NEW.IdZwierzecia) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdZwierzecia';
END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_leczenia
BEFORE UPDATE ON leczenia
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM leczenia WHERE IdZwierzecia = NEW.IdZwierzecia) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdZwierzecia';
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_lekarze
BEFORE DELETE ON lekarze
FOR EACH ROW
BEGIN
DELETE FROM zabiegiLekarze WHERE IdLekarza = OLD.IdLekarza;
DELETE FROM wizytyLekarze WHERE IdLekarza = OLD.IdLekarza;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_leki
BEFORE DELETE ON leki
FOR EACH ROW 
BEGIN
DELETE FROM szczegolywizytyrecepty WHERE IdLeku = OLD.IdLeku;
DELETE FROM szczegolyzabiegirecepty WHERE IdLeku = OLD.IdLeku;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `log` VALUES (1,'Info','deleted appointment with id: 41','2025-03-24 22:17:13'),(2,'Info','deleted animal with id: 32','2025-03-24 22:17:13');
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER add_wizyty
BEFORE INSERT ON wizyty
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM wizyty WHERE IdZwierzecia = NEW.IdZwierzecia) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdZwierzecia';
END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_wizyty
BEFORE UPDATE ON wizyty
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM wizyty WHERE IdZwierzecia = NEW.IdZwierzecia) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdZwierzecia';
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_wizyty
BEFORE DELETE ON wizyty
FOR EACH ROW
BEGIN
DELETE FROM wizytyrecepty WHERE IdWizyty = OLD.IdWizyty;
DELETE FROM wizytyleczenia WHERE IdWizyty = OLD.IdWizyty;
DELETE FROM wizytylekarze WHERE IdWizyty = OLD.IdWizyty;

INSERT INTO log(status, message, date)
VALUES ('Info', CONCAT('deleted appointment with id: ',OLD.IdWizyty), NOW());
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER add_wizytyrecepty
BEFORE INSERT ON wizytyrecepty
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM wizyty WHERE IdWizyty = NEW.IdWizyty) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdWizyty';
END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER add_zabiegirecepty
BEFORE INSERT ON wizytyrecepty
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM zabiegi WHERE IdWizyty = NEW.IdWizyty) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdZabiegu';
END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_wizytyrecepty
BEFORE UPDATE ON wizytyrecepty
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM wizyty WHERE IdWizyty = NEW.IdWizyty) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdWizyty';
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_zabiegirecepty
BEFORE UPDATE ON wizytyrecepty
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM zabiegi WHERE IdWizyty = NEW.IdWizyty) THEN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_wizytyrecepty
BEFORE DELETE ON wizytyrecepty
FOR EACH ROW
BEGIN
DELETE FROM szczegolywizytyrecepty WHERE IdRecepty = OLD.IdRecepty;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_wlasciciele
BEFORE DELETE ON wlasciciele
FOR EACH ROW
BEGIN
DELETE FROM zwierzetawlasciciele WHERE IdWlasciciela = OLD.IdWlasciciela;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER add_zabiegi
BEFORE INSERT ON zabiegi
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM zabiegi WHERE IdZwierzecia = NEW.IdZwierzecia) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdZwierzecia';
END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_zabiegi
BEFORE UPDATE ON zabiegi
FOR EACH ROW
BEGIN
IF NOT EXISTS(SELECT * FROM zabiegi WHERE IdZwierzecia = NEW.IdZwierzecia) THEN
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Not valid IdZwierzecia';
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_zabiegi
BEFORE DELETE ON zabiegi
FOR EACH ROW
BEGIN
DELETE FROM zabiegirecepty WHERE IdZabiegu = OLD.IdZabiegu;
DELETE FROM zabiegileczenia WHERE IdZabiegu = OLD.IdZabiegu;
DELETE FROM zabiegilekarze WHERE IdZabiegu = OLD.IdZabiegu;

INSERT INTO log(status, message, date)
VALUES ('Info', CONCAT('deleted surgery with id: ',OLD.IdZabiegu), NOW());
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_zabiegirecepty
BEFORE DELETE ON zabiegirecepty
FOR EACH ROW
BEGIN
DELETE FROM szczegolyzabiegirecepty WHERE IdRecepty = OLD.IdRecepty;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER delete_related_to_animals
BEFORE DELETE ON zwierzeta
FOR EACH ROW
BEGIN
DELETE FROM leczenia WHERE IdZwierzecia = OLD.IdZwierzecia;
DELETE FROM zabiegi WHERE IdZwierzecia = OLD.IdZwierzecia;
DELETE FROM wizyty WHERE IdZwierzecia = OLD.IdZwierzecia;
DELETE FROM zwierzetawlasciciele WHERE IdZwierzecia = OLD.IdZwierzecia;

INSERT INTO log(status, message, date)
VALUES ('Info', CONCAT('deleted animal with id: ',OLD.idZwierzecia), NOW());
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2025-03-25 20:11:46
