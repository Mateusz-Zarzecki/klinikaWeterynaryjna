...
INSERT INTO `leczenia` VALUES (1,1,'2021-01-15 00:00:00',NULL,'Leczenie po amputacji ogona'),(2,NULL,'2021-02-20 00:00:00',NULL,'Leczenie infekcji dróg oddechowych'),(3,3,'2021-03-05 00:00:00','2023-04-01 00:00:00','Leczenie dermatologiczne'),(4,4,'2021-04-10 00:00:00',NULL,'Leczenie stomatologiczne'),(5,5,'2021-05-15 00:00:00','2023-05-01 00:00:00','Leczenie ortopedyczne'),(6,6,'2021-06-20 00:00:00',NULL,'Kontynuacja leczenia dermatologicznego'),(7,7,'2021-07-25 00:00:00',NULL,'Leczenie stomatologiczne'),(8,10,'2021-10-05 00:00:00','2023-06-01 00:00:00','Szczepienie i odrobaczanie'),(9,11,'2021-11-12 00:00:00',NULL,'Operacja oka'),(10,13,'2022-01-20 00:00:00','2023-07-01 00:00:00','Kontrola stomatologiczna'),(11,16,'2023-06-05 00:00:00',NULL,'Leczenie neurologiczne'),(12,17,'2023-07-10 00:00:00',NULL,'Leczenie dermatologiczne'),(13,18,'2023-08-15 00:00:00','2023-09-01 00:00:00','Kontrola po zabiegu'),(14,14,'2022-02-15 00:00:00',NULL,'Szczepienie'),(15,15,'2022-03-10 00:00:00','2023-05-15 00:00:00','Leczenie zapalenia ucha'),(16,6,'2022-09-12 00:00:00',NULL,'Kontynuacja leczenia dermatologicznego'),(17,9,'2021-09-10 00:00:00',NULL,'Leczenie kardiologiczne'),(18,3,'2022-06-15 00:00:00','2023-08-01 00:00:00','Leczenie dermatologiczne');
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `dlugosc_lancucha` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `dlugosc_lancucha`(tekst VARCHAR(1000)) RETURNS int(11)
BEGIN 
DECLARE dlugosc INT;
SET dlugosc = LENGTH(tekst);
RETURN dlugosc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `liczba_rekordow_wlasciciele` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `liczba_rekordow_wlasciciele`() RETURNS int(11)
BEGIN
DECLARE liczba INT;
SELECT COUNT(*) INTO liczba FROM wlasciciele;
RETURN liczba;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `pobierze_date_rozpoczecia_leczenia` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `pobierze_date_rozpoczecia_leczenia`(id INT) RETURNS datetime
BEGIN
DECLARE data DATETIME;
SELECT DataRozpoczecia INTO data FROM leczenia
WHERE leczenia.IdLeczenia = id;
RETURN data;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `suma_lekow` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `suma_lekow`() RETURNS decimal(10,2)
BEGIN
DECLARE suma DECIMAL(10,2);
SELECT SUM(Cena) INTO suma FROM leki;
RETURN suma;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `aktualizuj_leki` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `aktualizuj_leki`(IN id_leku INT, IN nazwa_leku VARCHAR(200), IN cena_leku DECIMAL(10,2), 
IN opis_leku VARCHAR(1000) )
BEGIN
UPDATE leki SET Nazwa = nazwa_leku, Cena = cena_leku, Opis = opis_leku
WHERE IdLeku = id_leku;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `dlugosc_opisu_zabiegu` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `dlugosc_opisu_zabiegu`(IN id INT)
BEGIN
DECLARE opis VARCHAR(1000);
SELECT OpisZabiegu INTO opis FROM zabiegi
WHERE zabiegi.IdZabiegu = id;
SELECT dlugosc_lancucha(opis) AS dlugosc_opisu_zabiegu;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `dodajLekWizyty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `dodajLekWizyty`(IdRecepty INT(11), IdLeku INT(11), Ilosc INT(11))
BEGIN 

IF (EXISTS(SELECT * FROM Leki l WHERE l.IdLeku = IdLeku)) THEN 
	INSERT INTO szczegolywizytyrecepty (IdRecepty, IdLeku, Ilosc)
	VALUES (IdRecepty, IdLeku, Ilosc);
ELSE
	SELECT "Nie mozna dodac leku" as ERROR;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `dodaj_gatunek` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `dodaj_gatunek`(IN nazwa_gatunku VARCHAR(100), IN sredniaWaga_gatunku DECIMAL(10,2), 
IN sredniCzasZycia_gatunku DECIMAL(10,2), IN czyZwierzeStadne_gatunku BOOLEAN)
BEGIN
INSERT INTO gatunki VALUES (nazwa_gatunku ,sredniaWaga_gatunku ,sredniCzasZycia_gatunku ,sredniCzasZycia_gatunku,  czyZwierzeStadne_gatunku);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `dodaj_lek` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `dodaj_lek`(IN nazwa_leku VARCHAR(200), IN cena_leku DECIMAL(10,2), 
IN opis_leku VARCHAR(1000) )
BEGIN
INSERT INTO leki (Nazwa, Cena, Opis)
VALUES (nazwa_leku,cena_leku,opis_leku);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `podwyzkaPensjiLekarza` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `podwyzkaPensjiLekarza`(IdLekarza INT(11), podwyzka DECIMAL(10,2))
BEGIN
    IF(EXISTS(SELECT * FROM Lekarze l WHERE l.IdLekarza = IdLekarza)) THEN
        UPDATE Lekarze l SET Pensja = Pensja + podwyzka WHERE l.IdLekarza = IdLekarza;
        SELECT CONCAT(Imie, ' ', Nazwisko, ' podwyzka: ', CAST(podwyzka AS CHAR(100))) AS INFO
        FROM Lekarze l
        WHERE l.IdLekarza = IdLekarza;
    ELSE
        SELECT 'Nie mozna dodac podwyzki' AS ERROR;
    END IF; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `redukcjaPensjiLekarza` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `redukcjaPensjiLekarza`(IdLekarza INT(11), redukcja DECIMAL(10,2))
BEGIN
IF(EXISTS(SELECT * FROM Lekarze l WHERE l.IdLekarza = IdLekarza)) THEN
UPDATE Lekarze l SET Pensja = Pensja - redukcja WHERE l.IdLekarza = IdLekarza;
SELECT CONCAT(Imie, ' ', Nazwisko, ' redukcja: -', CAST(redukcja AS CHAR(100))) AS INFO
        FROM Lekarze l
        WHERE l.IdLekarza = IdLekarza;
ELSE
SELECT 'Nie mozna zmniejszyc pensji' as ERROR;
END IF; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `redukcjaPensjiLekarzaWyjatki` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `redukcjaPensjiLekarzaWyjatki`(IdLekarza INT(11), redukcja DECIMAL(10,2))
BEGIN 

DECLARE nowaPensja DECIMAL(10,2);
...
IF (EXISTS(SELECT * FROM Lekarze l WHERE l.IdLekarza = IdLekarza)) THEN
SELECT l.Pensja - redukcja INTO nowaPensja FROM Lekarze l WHERE l.IdLekarza = IdLekarza;
IF(nowaPensja > 0) THEN
UPDATE Lekarze l SET Pensja = Pensja - redukcja WHERE l.IdLekarza = IdLekarza;
SELECT CONCAT(l.Imie, ' ', l.Nazwisko, ' redukcja -', CAST(redukcja AS CHAR(100))) AS INFO
FROM Lekarze l
WHERE l.IdLekarza = IdLekarza; 

COMMIT;
ELSE
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Nie mozna ustawic pensji ponizej 0 - redukcja jest za duza';
END IF;
ELSE
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Id lekarza jest nieprawidlowe';
END IF;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `rozpocznijRecepteWizyty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `rozpocznijRecepteWizyty`(IdWizyty INT(11), DataWystawienia DATETIME)
BEGIN 

START TRANSACTION;
IF (EXISTS(SELECT * FROM  Wizyty w WHERE w.IdWizyty = IdWizyty)) THEN 
	INSERT INTO wizytyRecepty(IdWizyty, DataWystawienia)
	VALUES(IdWizyty, DataWystawienia);
ELSE
	SELECT "Nie mozna utworzyc recepty" as ERROR;
END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usuwanie_leku` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usuwanie_leku`(IN id_leku INT)
BEGIN
DELETE FROM leki
WHERE IdLeku = id_leku;
END ;;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usuwanie_zwierzecia` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usuwanie_zwierzecia`(IN id_pr INT)
BEGIN
   ALTER TABLE Zabiegi
   MODIFY IdZwierzecia INT(11) NULL;
   ...
   UPDATE Zabiegi
   SET IdZwierzecia = NULL
   WHERE IdZwierzecia = id_pr;
   ...
   DELETE FROM zwierzetawlasciciele 
   WHERE IdZwierzecia = id_pr;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `wyswietlanie_lekow` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `wyswietlanie_lekow`()
BEGIN
SELECT * FROM leki;
END ;;
DELIMITER ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `wyswietlanie_zmian` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `wyswietlanie_zmian`(IN id_pr INT)
BEGIN

   SELECT * FROM Zwierzeta
   WHERE IdZwierzecia = id_pr;

   SELECT * FROM ZwierzetaWlasciciele
   WHERE IdZwierzecia = id_pr;
...
-- Dump completed on 2024-12-16 23:07:48
